...
public:
		...
		{
			cout << "------------------Bubble sort Ascendente------------------" << endl;
			...
			cout << endl;
			cout << "El tiempo de ejecucion del Bubble Sort ascendente para un array de " << tam << " elementos es: " << duracion.count() << " microsegundos" << endl;
		}
};